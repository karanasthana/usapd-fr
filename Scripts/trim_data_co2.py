...
def main():
    data1_no2 = pd.read_csv("/Users/karanasthana/Personal/usapd-fr/Scripts/daily_42101_2016.csv")
    data2_no2 = pd.read_csv("/Users/karanasthana/Personal/usapd-fr/Scripts/daily_42101_2017.csv")
    data3_no2 = pd.read_csv("/Users/karanasthana/Personal/usapd-fr/Scripts/daily_42101_2018.csv")
    data4_no2 = pd.read_csv("/Users/karanasthana/Personal/usapd-fr/Scripts/daily_42101_2019.csv")
    data5_no2 = pd.read_csv("/Users/karanasthana/Personal/usapd-fr/Scripts/daily_42101_2020.csv")
    ...
    temp = open('co2Temp.csv', 'w')          #change file name for pollutant
    header = ''
    ...
    i = 4500000 #will start with multiples of 15lakh
